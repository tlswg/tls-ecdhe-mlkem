...
* The first group uses X25519 {{rfc7748}} and is an update to X25519Kyber768Draft00 {{xyber}}, a widely deployed PQ/T hybrid combiner for TLS v1.3 deployed in 2024.
...
* The third group uses secp384r1 (NIST P-384). This group can be used in high security environments that require FIPS-approved mechanisms at conservative security levels.
